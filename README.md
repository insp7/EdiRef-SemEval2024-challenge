...
## Contribution
In this work, the major contributions are four-fold: 
1. Propose a novel task, called emotion-flip reasoning (EFR), in the conversation dialog.
2. Develop a new ground-truth dataset for EFR, called MELD-FR.
3. Benchmark MELD-FR through a Transformer-based model and present a strong baseline for the EFR task.
4. Develop a masked memory network based architecture for ERC, which outperforms several recent baselines.
